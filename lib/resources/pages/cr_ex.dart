...
class TodoCreatePage extends NyStatefulWidget {
  static RouteView path = ("/todo-create", (_) => TodoCreatePage());

  TodoCreatePage({super.key}) : super(child: () => _TodoCreatePageState());
}

class _TodoCreatePageState extends NyPage<TodoCreatePage> {
  @override
  get init => () {};
